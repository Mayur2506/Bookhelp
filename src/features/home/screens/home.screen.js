...
export default function HomeScreen({ navigation }) {
  ...
  useEffect(() => {
    fetch(
      `https://api.nytimes.com/svc/books/v3/lists/current/combined-print-and-e-book-fiction.json?api-key=jGMkPamYwT8ricY9lovHguodBQJXb5uV`
    )
      .then((res) => res.json())
      .then((res) => {
      ...
      .catch(console.error);
    fetch(
      `https://api.nytimes.com/svc/books/v3/lists/current/combined-print-and-e-book-nonfiction.json?api-key=jGMkPamYwT8ricY9lovHguodBQJXb5uV`
    )
      .then((res) => res.json())
      .then((res) => {
